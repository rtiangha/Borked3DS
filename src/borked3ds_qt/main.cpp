...
void GMainWindow::OnMenuSetUpSystemFiles() {
    ...
    QLabel label_description(
        tr("<p>Borked3DS needs files from a real console to be able to use some of its "
           "features.<br>"
           ...
           "files "
           "to Borked3DS, do not share your user or nand folders<br>after performing the setup "
