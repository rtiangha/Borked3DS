...
ResultStatus Apploader_Artic::LoadExecImpl(std::shared_ptr<Kernel::Process>& process,
    ...
    codeset->CodeSegment().size =
        exheader.codeset_info.text.num_max_pages * Memory::BORKED3DS_PAGE_SIZE;
    ...
    codeset->RODataSegment().size =
        exheader.codeset_info.ro.num_max_pages * Memory::BORKED3DS_PAGE_SIZE;
    ...
    codeset->DataSegment().size =
        exheader.codeset_info.data.num_max_pages * Memory::BORKED3DS_PAGE_SIZE + bss_page_size;
