...
Config::Config() {
    ...
    sdl3_config_loc = FileUtil::GetUserPath(FileUtil::UserPath::ConfigDir) + "sdl3-config.ini";
...
void Config::ReadValues() {
    ...
    Settings::values.camera_name[OuterRightCamera] =
        sdl3_config->GetString("Camera", "camera_outer_right_name", "blank");
    ...
    NetSettings::values.web_api_url =
        sdl3_config->GetString("WebService", "web_api_url", "https://api.borked3ds-emu.org");
    NetSettings::values.borked3ds_username =
        sdl3_config->GetString("WebService", "borked3ds_username", "");
    NetSettings::values.borked3ds_token =
        sdl3_config->GetString("WebService", "borked3ds_token", "");
